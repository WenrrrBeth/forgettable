  ...
  return (
    <Container className={classes.authContainer}>
      <Paper className={classes.auth} elevation={0}>
            ...
            <Link className={classes.signupOpt}>
        ...
        <Button className={classes.signinButton}>{login ? "Sign In" : "Sign Up"}</Button>
        <Link className={classes.google} component="button" variant="body1" onClick={() => {}}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 40 40"
            width="27px"
